...
def downloadfritzascii(outfile):
    ...
    date = '2021-07-10' #Specify the date from which you want to check the saved sources
...
#f = ascii.read("Sources.ascii")

sources = f['col1']

#sources = ['ZTF21abjamta', 'ZTF21abklnfg']
